...
<template>
  <div class="home">
    <div class="album py-3 bg-light"> <!-- ③ 상품 목록 출력 요소 상품개수만큼 반복하여 카드 컴포넌트에 출력하고, 카드 컴포넌트에 상품 데이터 전달-->
      <div class="container"> <!-- ④  템플릿의 핵심요소를 감싸는 컨테이너 max-width 설정-->
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 g-2"> <!-- ⑤ 열을 나타내는 요소 row-cols-* 클래스로 화면크기에 따라 하나의 열에 몇개의 컬럼을 출력할지 지정, g-3는 열간의 수직,수평 간격 적용-->
