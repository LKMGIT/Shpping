...
import com.lkm.tappingshop.block.service.BlockService;
import com.lkm.tappingshop.common.util.HttpUtils;
import com.lkm.tappingshop.common.util.TokenUtils;
import com.lkm.tappingshop.member.entity.Member;
import com.lkm.tappingshop.member.service.BaseMemberService;
...
public class TokenAccountHelper implements AccountHelper {
    ...
    private final BaseMemberService memberService; // ④ 회원 서비스
